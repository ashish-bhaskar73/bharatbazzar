...
const Cart = () => {
    ...
    return (
        <>
            <MetaData title="Shopping Cart | bharatbazzar" />
            <main className="w-full mt-20">
                ...
                <div className="flex flex-col sm:flex-row gap-3.5 w-full sm:w-11/12 mt-0 sm:mt-4 m-auto sm:mb-7">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex flex-col shadow b border border-black bg-grey-200 ">
                        ...
                        <div className="flex flex-col mt-5 shadow border border-black bg-grey-200">
